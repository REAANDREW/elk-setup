...
curl -X POST -H 'Content-type:application/json' -d '{"text":"test 1","complete":false}' http://192.168.56.50:3000/api/v1/todos
curl -X POST -H 'Content-type:application/json' -d '{"text":"test 2","complete":false}' http://192.168.56.50:3000/api/v1/todos
curl -X POST -H 'Content-type:application/json' -d '{"text":"test 3","complete":false}' http://192.168.56.50:3000/api/v1/todos

echo
echo "See what todos we have"
curl http://192.168.56.50:3000/api/v1/todos
